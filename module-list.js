(function(){
    var modules={
       ...
       "participant-form":   		        {url:"$H/m/participant/participant-form.html",Table:"participant-reshaped"},
        ...
        "ravlt-7-bl-data-reshaped":                {url:"$H/m/library/ravlt-data.html",Table:"ravlt-bl-reshaped",form_module:"ravlt-7-bl-form-reshaped",task_name:"Baseline - RAVLT Trials 7"},
        "ravlt-7-bl-form-reshaped":                {url:"$H/m/library/ravlt-form.html",Table:"ravlt-bl-reshaped",task_name:"Baseline - RAVLT Trials 7"},
        ...
        "aqol-bl-data-reshaped":                {url:"$H/m/library/aqol-data.html",Table:"aqol-bl-reshaped",form_module:"aqol-bl-form-reshaped",task_name:"Baseline - Assessment of Quality of Life (AQoL-4D)"},
        "aqol-bl-form-reshaped":                {url:"$H/m/library/aqol-form.html",Table:"aqol-bl-reshaped",task_name:"Baseline - Assessment of Quality of Life (AQoL-4D)"},
