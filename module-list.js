(function(){
    var modules={
       ...
       "participant-form":   		        {url:"$H/m/participant/participant-form.html",Table:"participant-reshaped"},
        ...
        "cantab-pal-bl-data-reshaped":                {url:"$H/m/library/cantab-pal-data.html",Table:"cantab-pal-bl-reshaped",form_module:"cantab-pal-bl-form-reshaped",task_name:"Baseline - CANTAB Pair Associated Learning Test"},
        "cantab-pal-bl-form-reshaped":                {url:"$H/m/library/cantab-pal-form.html",Table:"cantab-pal-bl-reshaped",task_name:"Baseline - CANTAB Pair Associated Learning Test"},
        "cantab-rvp-bl-data-reshaped":                {url:"$H/m/library/cantab-rvp-data.html",Table:"cantab-rvp-bl-reshaped",form_module:"cantab-rvp-bl-form-reshaped",task_name:"Baseline - CANTAB Rapid Visual Processing Test"},
        "cantab-rvp-bl-form-reshaped":                {url:"$H/m/library/cantab-rvp-form.html",Table:"cantab-rvp-bl-reshaped",task_name:"Baseline - CANTAB Rapid Visual Processing Test"},
        "cantab-mtt-bl-data-reshaped":                {url:"$H/m/library/cantab-mtt-data.html",Table:"cantab-mtt-bl-reshaped",form_module:"cantab-mtt-bl-form-reshaped",task_name:"Baseline - CANTAB Multitasking Test"},
        "cantab-mtt-bl-form-reshaped":                {url:"$H/m/library/cantab-mtt-form.html",Table:"cantab-mtt-bl-reshaped",task_name:"Baseline - CANTAB Multitasking Test"},
